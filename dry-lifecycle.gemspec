...
Gem::Specification.new do |spec|
  ...
  spec.version       = Dry::Lifecycle::VERSION
  spec.authors       = ["Brian V. Hughes"]
  spec.email         = ["brianvh89@gmail.com"]

  spec.summary       = %q{A State Machine (aka. Lifecycle) designed for dry-rb.}
  ...
  spec.add_development_dependency "dry-transaction", "~> 0.13.0"
end
